...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateRoute:
          onGenerateRoute as Route<dynamic>? Function(RouteSettings)?,
      routes: RegistRoutes,
      home: const Logo(),
    );
  }
...
void _getCounter(context) async {
  String conunt = await getLocalCache(globalCache.allowProtocol);
  bool confirm = false;
  if (conunt == 'true') {
    confirm = true;
  } else {
  ...
  if (confirm) {
    String guidanced = await getLocalCache(globalCache.guidanced);
    if(guidanced=='true'){
    ...
    writeLocalCache(globalCache.allowProtocol, 'false');
  }
}
                  ...
                  child: ElevatedButton(
                      style: ButtonStyle(
                          ...
                          backgroundColor: MaterialStateProperty.resolveWith(
                              (states) => const Color.fromRGBO(0, 180, 120, 1)),
                      ...
                      onPressed: () {
                        dispose();
                        writeLocalCache(globalCache.allowProtocol, 'true');
